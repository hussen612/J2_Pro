...
class AutoClickerChain {
  ...
  static createUpgrades(chainLabel) {
    return [
      ...
      {
        id: 2,
        name: `${chainLabel} - Cookie Conveyor`,
        cost: 100,
        increment: 2,
        count: 0,
      },
      ...
      {
        id: 4,
        name: `${chainLabel} - Oven Overcharger`,
        cost: 2000,
        increment: 10,
        count: 0,
      },
      {
        id: 5,
        name: `${chainLabel} - Pastry Processor`,
        cost: 10000,
        increment: 20,
        count: 0,
      },
      {
        id: 6,
        name: `${chainLabel} - Sugar Synthesizer`,
        cost: 40000,
        increment: 50,
        count: 0,
      },
      {
        id: 7,
        name: `${chainLabel} - Frosting Facilitator`,
        cost: 200000,
        increment: 100,
        count: 0,
      },
      {
        id: 8,
        name: `${chainLabel} - Grandma's Oven`,
        cost: 1000000,
        increment: 250,
        count: 0,
      },
...
class Game {
  ...
  constructor() {
    ...
    this.mouseUpgradeSystem = new MouseUpgradeSystem(
      document.getElementById("mouse-upgrade"),
      this
    );
  ...
  startTimers() {
    setInterval(() => {
      ...
      let totalAuto = this.autoClickerChains.reduce(
        (sum, chain) => sum + chain.autoValue,
        0
      );
